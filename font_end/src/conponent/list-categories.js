    ...
    async render(){
        ...
        <div class="container-fluid">
          <div class="row row-offcanvas row-offcanvas-right">
            ...
            <thead>
            <a href="/#/add-categories" class="btn btn-primary btn-xs pull-right"><b>+</b> Add new categories</a>
                <tr>
                    <th>#</th>
                    <th>Name</th>
                    <th>Action</th>
                    ...
                    ${category.map((value,index=1)=>{
                        ...
                        <a class='btn btn-info btn-xs' href="/#/category-edit/${value._id}"><span class="glyphicon glyphicon-edit"></span> Edit</a>
                         <a data-id="${value._id}" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-remove"></span> Del</a></td>
                    </tr>
                        `
                    }).join('')}
