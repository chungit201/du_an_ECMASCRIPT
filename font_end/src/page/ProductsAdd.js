                         ...
                         <div class="row justify-content-center">
                             <div class="col-md-8">
                                 <div class="card">
                                     ...
                                     <div class="card-body">
                                         <form id="form-add" method="">
                                             ...
                                             <div class="col-md-6">
                                                 <input type="text" id="name" class="form-control" name="" required autofocus>
                                             </div>
                                         </div>
                                         <div class="form-group row">
                                         <label for="" class="col-md-4 col-form-label text-md-right">Ảnh</label>
                                         <div class="col-md-6">
                                             <input type="file" id="image" class="form-control" name="" required autofocus>
                                         </div>
                                     </div>
                                 ...
                                 <div class="form-group row">
                                     ...
                                     <div class="col-md-6">
                                         <input type="number" id="oldprice" class="form-control" name="" required autofocus>
                                     </div>
                                 </div>
                                 <div class="form-group row">
                                 <label for="" class="col-md-4 col-form-label text-md-right">Giá khuyến mãi</label>
                                 <div class="col-md-6">
                                     <input type="number" id="price" class="form-control" name="" required autofocus>
                                 </div>
                             </div>
                                 <div class="form-group row">
                                 <label for="" class="col-md-4 col-form-label text-md-right">Số lượng</label>
                                 <div class="col-md-6">
                                     <input type="number" id="quantity" class="form-control" name="" required autofocus>
                                 </div>
                             </div>
                             <div class="form-group row">
                             <label for="" class="col-md-4 col-form-label text-md-right">Mô tả</label>
                             <div class="col-md-6">
                                 <input type="text" id="description" class="form-control" name="" required autofocus>
                             </div>
                              </div>
